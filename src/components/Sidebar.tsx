  ...
  const menuGroups: { title: string; items: { id: string; label: string; icon: typeof LayoutDashboard; requiredPermission: string | null }[] }[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { id: "product-analysis", label: "Ürün Analizi (Beta)", icon: Camera, requiredPermission: "ai:read" },
        { id: "product-document-qa", label: "Belgelere Sor (Beta)", icon: MessageCircleQuestion, requiredPermission: "inventory:read" },
        { id: "product-capture-session", label: "Ürün Toplama Oturumu (Beta)", icon: FolderPlus, requiredPermission: "inventory:write" },
